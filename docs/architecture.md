...
| **MCP server**     | `mcp-server/askuserquestionspro-mcp.mjs`                                                                           | Host-neutral `ask` and detached-round `resume` tools used by Claude Code, Codex CLI, Antigravity CLI, and ChatGPT Desktop.                   |
...
| **Host installer** | `lib/host-platforms.cjs`, `lib/antigravity.cjs`, `bin/cli.js`, `skill/askpro/SKILL.md`                             | Selects Claude/Codex/Antigravity, registers MCP, and deploys host-native skill guidance.                                                     |
