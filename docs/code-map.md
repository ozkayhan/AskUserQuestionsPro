...
| `lib/host-platforms.cjs`                 | Target parsing, Claude/Codex/Antigravity discovery, MCP CLI argv, manual commands, and host-native skill destinations.                                                                                                                 | Change host selection or installation contracts.                                               |
| `lib/antigravity.cjs`                    | Antigravity global MCP JSON merge, plugin/skill deployment, and scoped removal/inspection helpers.                                                                                                                                     | Change Antigravity CLI registration or plugin lifecycle.                                       |
...
| `skill/askpro/SKILL.md`                  | Guidance installed for Claude, Codex, and Antigravity; prefers MCP for structured interactions and names host-native fallbacks.                                                                                                        | Change agent tool-selection guidance.                                                          |
