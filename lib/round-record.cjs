...
function transition(record, event, expectedRevision, now, details = {}) {
  ...
  return {
    ...
    record: revised(
      record,
      { lifecycle: { ...record.lifecycle, state: nextState, updatedAt: now, ...details } },
      now
    ),
  };
}
  ...
  return {
    ...
    record: revised(
      record,
      {
        ...
        lifecycle: { ...record.lifecycle, state: 'delivery-pending', updatedAt: now },
      },
      now
    ),
  };
  ...
  return {
    ...
    record: revised(
      record,
      {
        ...
        lifecycle: { ...record.lifecycle, state: 'delivered', updatedAt: now },
      },
      now
    ),
  };
