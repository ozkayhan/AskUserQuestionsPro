...
# TAM kaldırır (askpro skill dahil); install skill'i GitHub'dan geri kurar.
...
printf '%s\n\n' "${C_BOLD}AskUserQuestionsPro yeniden kurulumu${C_RESET}"
...
bash "$INSTALL_SH" || die "install başarısız — yukarıdaki hataya bakın."

printf '\n%s\n' "${C_BOLD}${C_GREEN}✓ Yeniden kurulum tamamlandı. Yeni bir 'claude' oturumu açın.${C_RESET}"
