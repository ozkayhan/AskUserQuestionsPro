...
- [ ] **Phase 1: Timeout Diagnosis & Observability** - Reproduce the early closure and identify the true lifecycle owner with redacted diagnostics.
...
Plans:
- [ ] 01-01: Add redacted lifecycle correlation and timeout diagnostics.
- [ ] 01-02: Build deterministic long-round, disconnect, and host-boundary regression harness.
...
|-------|----------------|--------|-----------|
| 1. Timeout Diagnosis & Observability | 0/2 | Not started | - |
